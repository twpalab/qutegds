...
html_title = "qutegds · " + release

html_theme_options = {
    "top_of_page_button": "edit",
    "source_repository": "https://github.com/twpalab/qutegds/",
    "source_branch": "main",
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/twpalab/qutegds",
            "html": """
...
def run_apidoc(_):
    ...
    package = source.parents[1] / "src" / "qutegds"
